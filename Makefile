...
SRC_PRINTF = ./printf/ft_printf.c ./printf/ft_print_hexl.c ./printf/ft_print_hexu.c  ./printf/ft_print_nb.c ./printf/ft_print_ptr.c ./printf/ft_print_putchar.c ./printf/ft_print_putstr.c ./printf/ft_print_unb.c
...
SRC += $(SRC_CHARACTER) $(SRC_GENERAL) $(SRC_LIST) $(SRC_MEMORY) $(SRC_write) $(SRC_STRING) $(SRC_GET_NEXT_LINE) $(SRC_VECTOR) $(SRC_EXTRA) $(SRC_PRINTF)
